...
export function ImageSlider({ images }: iAppProps) {
  ...
  return (
    <div className="w-full">
      <div className="grid gap-4 sm:gap-6 items-start w-full">
        <div className="relative overflow-hidden rounded-lg w-full aspect-square max-w-full">
          <Image
            width={600}
            height={600}
        ...
        <div className="grid grid-cols-4 sm:grid-cols-5 gap-2 sm:gap-4 w-full">
          {images.map((image, index) => (
            <div
              className={cn(
                index === mainImageIndex ? 'border-2 border-primary/25' : 'border border-gray-200',
